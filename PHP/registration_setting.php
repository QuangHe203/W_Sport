    ...
    <form action="" method="post">
        <div class="main">
            ...
            <div class="option">
                ...
                <div class="required">
                    <label class="required_checkbox">
                        <input type="checkbox" name="requiredName_email" id="requiredName_email" value="1" <?php if ($dataRR['name_email'] == 1) {
                                                                                                                echo "checked";
                                                                                                            } else {
                                                                                                                echo "";
                                                                                                            } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="requiredPhone" id="requiredPhone" value="1" <?php if ($dataRR['phone'] == 1) {
                                                                                                        echo "checked";
                                                                                                    } else {
                                                                                                        echo "";
                                                                                                    } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="requiredGender" id="requiredGender" value="1" <?php if ($dataRR['gender'] == 1) {
                                                                                                        echo "checked";
                                                                                                    } else {
                                                                                                        echo "";
                                                                                                    } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="requiredBirthday" id="requiredBirthday" value="1" <?php if ($dataRR['birthday'] == 1) {
                                                                                                            echo "checked";
                                                                                                        } else {
                                                                                                            echo "";
                                                                                                        } ?>>
            ...
            <div class="option">
                ...
                <div class="required">
                    <label class="required_checkbox">
                        <input type="checkbox" name="IndividualPlayer" id="IndividualPlayer" value="1" <?php if ($dataRR['individualPlayer'] == 1) {
                                                                                                            echo "checked";
                                                                                                        } else {
                                                                                                            echo "";
                                                                                                        } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="TeamPlayer" id="TeamPlayer" value="1" <?php if ($dataRR['teamPlayer'] == 1) {
                                                                                                echo "checked";
                                                                                            } else {
                                                                                                echo "";
                                                                                            } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="Coach" id="Coach" value="1" <?php if ($dataRR['coach'] == 1) {
                                                                                        echo "checked";
                                                                                    } else {
                                                                                        echo "";
                                                                                    } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="staff" id="staff" value="1" <?php if ($dataRR['staff'] == 1) {
                                                                                        echo "checked";
                                                                                    } else {
                                                                                        echo "";
                                                                                    } ?>>
                    ...
                    <label class="required_checkbox">
                        <input type="checkbox" name="Individual" id="Individual" value="1" <?php if ($dataRR['individual'] == 1) {
                                                                                                echo "checked";
                                                                                            } else {
                                                                                                echo "";
                                                                                            } ?>>
